...
public class UserDTO {
    ...
    public User toUser() {
        switch (type) {
            case "GlassesUser":
                return new GlassesUser(dni, name, apellidos, email, password, telefono, username, (int) specificProperties.get("age"), (String) specificProperties.get("gender"));
            case "FoodSpecialist":
                return new FoodSpecialist(dni, name, apellidos, email, password, telefono, username, (String) specificProperties.get("organization"));
            case "Cliente":
                return new Cliente(dni, name, apellidos, email, password, telefono, username, (String) specificProperties.get("business"), (String) specificProperties.get("bankAccount"));
            case "DataAnalyst":
                return new DataAnalyst(dni, name, apellidos, email, password, telefono, username);
            default:
                return null;
        }
    }
